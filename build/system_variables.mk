...
# purely relative path is wrong.
CONTRIB_ROOT := $(CURDIR)/../../contrib
HDF5DIR  := $(CONTRIB_ROOT)/hdf5
# SZIPDIR  := $(CONTRIB_ROOT)
CGNSDIR  := $(CONTRIB_ROOT)/cgns
METISDIR := $(CONTRIB_ROOT)/metis
